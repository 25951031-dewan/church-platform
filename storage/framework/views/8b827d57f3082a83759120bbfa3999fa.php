...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', $settings->church_name ?? config('app.name', 'Grace Community Church')); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $settings->meta_description ?? 'Welcome to our church community.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', $settings->meta_keywords ?? ''); ?>">

    
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', $settings->church_name ?? config('app.name')); ?>">
    ...
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('og_title', $settings->church_name ?? config('app.name')); ?>">
...
<body>
        ...
        <div class="container">
            <a href="/" class="logo">
                <?php if($settings && $settings->logo): ?>
                    <img src="/storage/<?php echo e($settings->logo); ?>" alt="<?php echo e($settings->church_name ?? 'Church'); ?>" style="height:36px;">
                <?php else: ?>
                    <?php echo e($settings->church_name ?? config('app.name', 'Grace Community Church')); ?>

                <?php endif; ?>
            </a>
            <nav>
                <a href="/">Home</a>
                <a href="/blog" class="<?php echo e(request()->is('blog*') ? 'active' : ''); ?>">Blog</a>
                <a href="/ministries" class="<?php echo e(request()->is('ministries*') ? 'active' : ''); ?>">Ministries</a>
                <a href="/bible-studies" class="<?php echo e(request()->is('bible-studies*') ? 'active' : ''); ?>">Bible Study</a>
                <a href="/library" class="<?php echo e(request()->is('library*') ? 'active' : ''); ?>">Library</a>
                <a href="/about" class="<?php echo e(request()->is('about') ? 'active' : ''); ?>">About</a>
            </nav>
        </div>
    </header>
    ...
    <footer class="site-footer">
        <div class="container">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($settings->church_name ?? config('app.name')); ?>. All rights reserved.</p>
            <div class="social-links">
                <?php if($settings->facebook_url ?? false): ?><a href="<?php echo e($settings->facebook_url); ?>" target="_blank"><i class="fab fa-facebook-f"></i></a><?php endif; ?>
                <?php if($settings->twitter_url ?? false): ?><a href="<?php echo e($settings->twitter_url); ?>" target="_blank"><i class="fab fa-twitter"></i></a><?php endif; ?>
                <?php if($settings->instagram_url ?? false): ?><a href="<?php echo e($settings->instagram_url); ?>" target="_blank"><i class="fab fa-instagram"></i></a><?php endif; ?>
                <?php if($settings->youtube_url ?? false): ?><a href="<?php echo e($settings->youtube_url); ?>" target="_blank"><i class="fab fa-youtube"></i></a><?php endif; ?>
            </div>
        </div>
    </footer>
...
<?php /**PATH /Users/siku/Documents/GitHub/church/resources/views/layouts/public.blade.php ENDPATH**/ ?>