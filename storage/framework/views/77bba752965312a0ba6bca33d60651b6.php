...
<head>
    ...
    <title>Login - <?php echo e(config('app.name', 'Church Platform')); ?></title>
...
<body class="min-h-screen flex items-center justify-center px-4 antialiased">
    <div class="w-full max-w-md">
        ...
        <p class="text-center mt-6 text-sm text-gray-400">
            Church Platform &copy; <?php echo e(date('Y')); ?>
...
<?php /**PATH /Users/siku/Documents/GitHub/church/resources/views/auth/login.blade.php ENDPATH**/ ?>