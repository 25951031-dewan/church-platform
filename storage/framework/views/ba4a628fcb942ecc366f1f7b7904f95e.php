...
<div class="p-8">
    ...
    <form action="<?php echo e(url('/install/database')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="db_database" id="db_database"
                       value="<?php echo e(old('db_database', '')); ?>"
                       class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl text-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors bg-gray-50 focus:bg-white"
...
<?php echo $__env->make('installer.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/siku/Documents/GitHub/church/resources/views/installer/database.blade.php ENDPATH**/ ?>