...
<nav class="nav-bar">
  <div class="nav-inner">
    <div class="nav-brand" onclick="navigate('home')">
      ...
      <span class="nav-brand-text" id="nav-church-name"><?php echo e(config('app.name', 'Grace Community Church')); ?></span>
    </div>
...
<div class="mobile-menu" id="mobile-menu">
  <div class="mobile-header">
    <span class="mobile-header-brand" id="mobile-brand-name"><?php echo e(config('app.name', 'Grace Community Church')); ?></span>
...
<footer class="site-footer">
  <div class="footer-brand" id="footer-name"><?php echo e(config('app.name', 'Grace Community Church')); ?></div>
...
<?php /**PATH /home/alphaome/nkhoj.com/resources/views/partials/frontend-html.blade.php ENDPATH**/ ?>